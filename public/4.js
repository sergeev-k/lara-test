...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this.$axios.get('/projects');
    ...
    subscribe: function subscribe(id, index) {},
  ...
  return _c(
    ...
    [
      _vm.projects.length
                    ...
                    "b-form-select",
                    {
                      ...
                      on: {
                        change: function($event) {
                          return _vm.subscribe(project.id, i)
                        }
                      },
                      model: {
                        value: _vm.selectedUser[i],
                        callback: function($$v) {
                          _vm.$set(_vm.selectedUser, i, $$v)
                        },
                        expression: "selectedUser[i]"
                      }
                    },
                    [
                      _c(
        ...
        : _c("p", { staticClass: "text-center" }, [_vm._v("Not Projects")])
    ],
    1
  )
}
